...
SECRET_KEY = 'django-insecure-8mwip%3bo4-h7*nv0t7308w8@2p2f7c&cr)yqxw^t-%$z)^hcn'
...
INSTALLED_APPS = [
    ...
    #Register 'Catalog' app to Project
    'catalog.apps.CatalogConfig', #We call the folder app 'catlog' file 'apps.py' and call the class 'CatalogConfig'
]
